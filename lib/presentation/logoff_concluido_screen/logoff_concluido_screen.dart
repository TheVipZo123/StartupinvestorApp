...
class LogoffConcluidoScreen extends StatelessWidget {
  @override
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      Align(
                          ...
                          child: Padding(
                              padding: getPadding(right: 30, bottom: 51),
                              child: Text("Logout Concluido",
                                  overflow: TextOverflow.ellipsis,
                                  textAlign: TextAlign.left,
  ...
  onTapArrowright8(BuildContext context) {
